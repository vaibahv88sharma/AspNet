...
namespace SomeUI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region Add Update Delete RawSQL
            ...
            #region EagerLoad via Projection
            ...
            #region Disconnected Graphs-----Lookups
            ...
            #region Changes and Additions to Change Tracker -- Track Parent but not Graph(Lookup)
            ...
            #region Change State using Entity Tracking -- Track Graphs(Lookup)
            ...
            #region Track Graph(Lookup) using custom Function
