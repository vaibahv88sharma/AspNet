...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController: Controller
    {
        ...
        public IActionResult GetPointOfInterest(int cityId, int id)
        {
            ...
            var pointsOfInterestResult = Mapper.Map<PointOfInterestDto>(pointsOfInterest);
            ...
            [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            // Route to another Route => in this case => GetPointOfInterest Action of the same controller
            return CreatedAtRoute("GetPointOfInterest", new
            { cityId = cityId, id = createdPointOfInterestToReturn.Id }, createdPointOfInterestToReturn);
            //                                                          createdPointOfInterestToReturn => for Response Body
        }
